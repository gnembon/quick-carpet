...
public class SettingsManager
{
    ...
    public void attachServer(MinecraftServer server)
    {
        ...
        registerCommand(server, server.getCommandManager().getDispatcher());
    ...
    private void registerCommand(MinecraftServer server, CommandDispatcher<ServerCommandSource> dispatcher)
    {
